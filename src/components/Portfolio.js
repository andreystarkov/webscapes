...
function iconDemo(){
  return(
  <div className="svg-icon icon-demo">
...
function iconGithub(){
  return(
    <div className="svg-icon icon-github">
            ...
            <div className="portfolio-item">
              <div className="bg-image" style={{backgroundImage: 'url('+obj.full+')'}}>
                <div className="description">
                  ...
                  <div className="links">
                    <a href={obj.github} target="_blank">{iconGithub()}</a>
                    <a href={obj.demo} target="_blank">{iconDemo()}</a>
                  </div>
                </div>
              </div>
            </div>
